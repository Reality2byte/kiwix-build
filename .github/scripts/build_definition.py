...
# Osx builds, build binaries on native_dyn and native_static. On anyother things, build only the libraries
    ...
    | macos     | ios_simulator_x86_64| dB     | dB       |           |             |               |                         | ios-x86_64-dyn         |
    ...
    | jammy     | android_x86        | BP     | BP       |           |             |               | android-x86             |                        |
    | jammy     | android_x86_64     | BP     | BP       |           |             |               | android-x86_64          |                        |
    | jammy     | armv6_static       |        |          | BP        | BP          |               | linux-armv6             |                        |
    | jammy     | armv6_mixed        | BP     |          |           |             |               | linux-armv6             |                        |
    | jammy     | armv6_dyn          |        |          | B         | B           |               |                         |                        |
    | jammy     | armv8_static       |        |          | BP        | BP          |               | linux-armv8             |                        |
    | jammy     | armv8_mixed        | BP     |          |           |             |               | linux-armv8             |                        |
    | jammy     | armv8_dyn          |        |          | B         | B           |               |                         |                        |
    | jammy     | aarch64_static     |        |          | BP        | BP          |               | linux-aarch64           |                        |
    | jammy     | aarch64_mixed      | BP     |          |           |             |               | linux-aarch64           |                        |
    | jammy     | aarch64_dyn        | d      |          | B         | B           |               |                         | linux-aarch64-dyn      |
